 ...
 * These enrich wire protocol models with UI-specific state and formatting.
 */
...
data class VerificationInfo(
    ...
    val flaggedAs: String? = null        // hallucinating, looping, inactive, null = clean
)

// ── Agent checklist for evidence-backed completion ──

data class ChecklistItem(
    val label: String,
    val status: ItemStatus = ItemStatus.PENDING,
    val evidence: String? = null         // commit hash, file hash, test result
)
...
data class ServerHealth(
    ...
    val flaggedAgentCount: Int = 0,       // hallucinating or looping
